            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        ...
                        <img class="fa fa-stack-1x skills-icon" src="${pageContext.request.contextPath }/resources/img/skills/html-5-logo.png">
                    </span>
                    <h4 class="service-heading">Web</h4>
                    <p class="text-muted">HTML, CSS, JavaScript, JQuery, Jsp, Spring Framework 가능합니다. DBMS는 MySQL 가능합니다.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                        <img class="fa fa-stack-1x skills-icon" src="${pageContext.request.contextPath }/resources/img/skills/java.png">
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                        <img class="fa fa-stack-1x skills-icon" src="${pageContext.request.contextPath }/resources/img/skills/android-logo.png">
                    </span>
                    <h4 class="service-heading">Android</h4>
                    <p class="text-muted">jQuery Mobile, Cordova를 활용한 Hybrid Application, Android Studio를 활용한 Android Application 개발 가능합니다.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">현재까지 진행한 프로젝트 목록입니다.</h3>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">지금까지의 학력과 교육 수료 사항입니다.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
	            		...
	            		<table id="table_contact" class="table">
	            			...
	            			<c:if test="${!empty cList }">
	            				<c:forEach items="${cList }" var="contact">
	            					<tr>
			            				<th class="cno">${contact.cno }</th>
			            				<th class="cname"><a href="#contactModal" data-toggle="modal" class="c_selected">${contact.cname }</a></th>
			            				<th class="cemail"><a href="#contactModal" data-toggle="modal" class="c_selected">${contact.cemail }</a></th>
			            				<th><input type="hidden" class="ccontent" value="${contact.ccontent }">${contact.cdateForm }</th>
			            			</tr>
